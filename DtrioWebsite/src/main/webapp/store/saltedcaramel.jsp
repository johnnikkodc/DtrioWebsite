			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						...
						<h2 style="font-weight: bold">Salted Caramel</h2>
						<span style="color: pink; font-weight: bold">PHP150.00</span>
					</div>
					<br>
					<p>Get ready to savor the irresistible taste of our salted
						caramel syrup. Made with high-quality ingredients and a perfect
						balance of sweet and salty flavors, this syrup is a must-have
						addition to any coffee or beverage lover's collection. Add a
						splash to your morning latte, or create your own signature drink
						by blending it with your favorite flavors. Elevate your coffee
						game with the indulgent richness of our salted caramel syrup!</p>
					<br>
