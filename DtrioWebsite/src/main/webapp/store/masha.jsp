			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						...
						<h2 style="font-weight: bold">Masha G1</h2>
						<span style="color: pink; font-weight: bold">PHP720.00</span>
					</div>
					<br>
					<p>We are excited to present a new specialty coffee from
						Africa, grown in Masha in the Sheka Zone and graded as G1, which
						is the highest grade given to Ethiopian coffee beans. Our medium
						roast emphasizes the peach, lychee, berries, and jasmine tea
						flavors of the beans. To enjoy the best taste, we recommend
						brewing the coffee within 1 to 6 weeks after the roast date
						printed on the bag as the flavors will change over time.</p>
					<br>
