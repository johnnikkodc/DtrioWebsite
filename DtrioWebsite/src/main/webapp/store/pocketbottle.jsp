			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						<span>Cold Brew</span>
						<h2 style="font-weight: bold">Pocket Bottle</h2>
						<span style="color: pink; font-weight: bold">PHP200.00</span>
					</div>
					<br>
					<p>Our mini version of the Panama Brew is ideal for
						first-timers, with each bottle containing 2 shots (100ml) of our
						premium cold brew concentrate made from 100% Panama beans. It's
						easy to carry around, making it perfect for on-the-go coffee
						lovers who can't resist a good cup of DTrio.</p>
					<br>
