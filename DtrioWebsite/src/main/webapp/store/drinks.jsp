...
<div class="wrapper">
  <div class="w3-display-container w3-container" style="margin-right:45px">
			<img src="../img/<%out.println(c29); %>" alt="watch" style="width:100%; border-radius:25px">
			<div class="w3-display-topleft w3-text-white" style="padding:70px 140px">
				<h1 style="font-weight: bold">COLD BREWS</h1>
			</div>
		</div>
  <div class="cards">
  <%
				try {
					...
					String type="coldbrew";
					ResultSet rs2 = st2.executeQuery("select *from product where category='" + type + "'");
					while (rs2.next()) {
						
				%>
   <div class="card" style = "background-color:white">
      <a href="coldbrew.jsp?id=<%=rs2.getString(1)%>" style=text-decoration:none;><img class="card__image" src="../img/<%=rs2.getString(5)%>" alt=""></a>
