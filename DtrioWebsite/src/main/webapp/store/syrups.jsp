...
<div class="wrapper">
  <div class="w3-display-container w3-container" style="margin-right:45px">
			<img src="../img/<%out.println(c27); %>" alt="watch" style="width:100%; border-radius:25px">
			<div class="w3-display-topleft w3-text-white" style="padding:70px 140px">
				<h1 style="font-weight: bold">COFFEE SYRUPS</h1>
			</div>
		</div>
  <div class="cards">
  <%
   ...
   <div class="card" style = "background-color:white">
      <a href="syrup.jsp?id=<%=rs2.getString(1)%>" style=text-decoration:none;><img class="card__image" src="../img/<%=rs2.getString(5)%>" alt=""></a>
