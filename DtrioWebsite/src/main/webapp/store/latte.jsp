			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						<span>Cold Brew</span>
						<h2 style="font-weight: bold">Panama Latte</h2>
						<span style="color: pink; font-weight: bold">PHP300.00</span>
					</div>
					<br>
					<p>Indulge in the rich and velvety taste of our best-selling
						cinnamon almond latte made with our signature Panama Brew. This
						250 ml glass bottle contains 2 long servings, perfectly blended
						for a creamy and flavorful coffee experience.</p>
					<br>
