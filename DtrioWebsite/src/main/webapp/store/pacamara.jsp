			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						...
						<h2 style="font-weight: bold">Pacamara #149</h2>
						<span style="color: pink; font-weight: bold">PHP800.00</span>
					</div>
					<br>
					<p>Pacamara is a coffee varietal resulting from the crossing of
						2 varietals: Pacas and Maragogipe, and is harvested and processed
						in Santa Clara, Panama. These fresh crop beans boast notes of
						tropical fruits like pineapple, earl grey tea, and cacao nibs when
						medium roasted.</p>
					<br>
