			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						...
						<h2 style="font-weight: bold">Caramel</h2>
						<span style="color: pink; font-weight: bold">PHP150.00</span>
					</div>
					<br>
					<p>Experience the indulgent sweetness of our caramel syrup - a
						perfect addition to your coffee and beverage creations. Made with
						premium ingredients, this syrup is the perfect way to elevate your
						morning latte or hot cocoa. Use it to add a touch of sweetness to
						your smoothies or milkshakes, or blend it with your favorite
						flavors for a custom drink. With its rich, buttery taste, our
						caramel syrup is sure to become your go-to sweetener!</p>
					<br>
