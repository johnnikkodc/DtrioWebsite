		...
		<div class="row">
			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					...
					<h2 style="font-weight: bold">Vanilla</h2>
					<span style="color: pink; font-weight: bold">PHP150.00</span>
				</div>
				<br>
				<p>Add a touch of creamy sweetness to your coffee and beverages
					with our vanilla syrup. Made with the highest quality vanilla
					beans, this syrup is the perfect complement to your morning latte
					or iced coffee. Use it to create your own signature drinks, or add
					a splash to your smoothies or milkshakes for a decadent treat. With
					its smooth and rich flavor, our vanilla syrup will elevate your
					coffee game to the next level!</p>
				<br>
