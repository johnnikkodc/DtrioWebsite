			...
			<div class="col-md-6" style="padding-right: 50px">
				<div class="product-dtl" style="padding-top: 60px">
					<div class="product-info">
						<span>Cold Brew</span>
						<h2 style="font-weight: bold">Panama Brew</h2>
						<span style="color: pink; font-weight: bold">PHP900.00</span>
					</div>
					<br>
					<p>Our top-selling product is an 18-serving, premium cold brew
						concentrate made from 100% Panama coffee beans and packaged in a
						refillable glass bottle. Our Manila-roasted beans are steeped in
						cold water to create a smooth, bold, and balanced brew with notes
						of caramel, dark chocolate, and a hint of orange. Dilute with
						water, milk, or your preferred mixer and savor the flavor!</p>
					<br>
